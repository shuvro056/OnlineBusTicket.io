...
<body>
	<div class="header">
		...
		<h1 style="text-align:center">Total Bus Information</h1>
	</div>	
<?php
$server="127.0.0.1";
$user="root";
...
if($db!=NULL)
	echo "";
$res=$db->query("select  schedule.name,schedule.bk,booked.payable from booked join schedule WHERE schedule.schedule_id=booked.schedule_id;");
if($res!=NULL)
{
echo"<table>
<tr>
<th>Bus Name &nbsp</th>
<th>Total Sell Ticket &nbsp</th>
