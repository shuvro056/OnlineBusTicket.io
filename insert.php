...
<body>
	<div class="header">
		...
		<h1 style="text-align:center">Insert BUS information</h1>
	</div>
	<!--<div class="slider">
		<div class="mid">
   ...
   <?php
	...
	if ( isset($_POST['submit']) ) {
		...
		$price = $_POST['price'];
		//var_dump($_POST); die();
		$sql 			= 'INSERT INTO schedule (`class`, `name` ,`departure_time`,`total_seat`,`available_seat`,`start_from`,`destination`,`journey_date`,`price`) VALUES ("'.$class.'", "'.$name.'", "'.$deptime.'", "'.$tseat.'", "'.$avseat.'", "'.$sfrom.'", "'.$destin.'", "'.$jdate.'","'.$price.'")';
